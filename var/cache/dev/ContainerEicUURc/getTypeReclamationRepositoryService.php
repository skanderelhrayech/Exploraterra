 ...
 */
class getTypeReclamationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TypeReclamationRepository' shared autowired service.
     *
     * @return \App\Repository\TypeReclamationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TypeReclamationRepository.php';

        return $container->privates['App\\Repository\\TypeReclamationRepository'] = new \App\Repository\TypeReclamationRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
