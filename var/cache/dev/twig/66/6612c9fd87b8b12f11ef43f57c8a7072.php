...
class __TwigTemplate_5e6795d7aafc3a58b4d27c1fdba4adcd extends Template
{
    private $source;
    private $macros = [];
...
<html>
    ...
    <body class=\"";
        ...
        ";
        // line 22
        if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 22, $this->source); })()), "request", [], "any", false, false, false, 22), "attributes", [], "any", false, false, false, 22), "get", ["_route"], "method", false, false, false, 22) != "login")) {
            // line 23
            echo "            ";
...
", "admin/base.html.twig", "C:\\xampp2\\htdocs\\ExploraTerra-gestionVol\\templates\\admin\\base.html.twig");
    }
}
