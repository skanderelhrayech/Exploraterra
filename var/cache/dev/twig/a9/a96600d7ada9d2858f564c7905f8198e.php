...
class __TwigTemplate_c8ea360e0926eed03c003c0b262b9470 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function macro_is_active($__segment__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            // line 2
            echo "    ";
            if (twig_in_filter((isset($context["segment"]) || array_key_exists("segment", $context) ? $context["segment"] : (function () { throw new RuntimeError('Variable "segment" does not exist.', 2, $this->source); })()), twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 2, $this->source); })()), "request", [], "any", false, false, false, 2), "attributes", [], "any", false, false, false, 2), "get", ["_route"], "method", false, false, false, 2))) {
                // line 3
                echo "        active
    ";
            }
    ...
    {% if segment in app.request.attributes.get('_route') %}
        active
    {% endif %}
{% endmacro %}", "partials/_macro.html.twig", "C:\\xampp2\\htdocs\\ExploraTerra-gestionVol\\templates\\partials\\_macro.html.twig");
    }
}
