...
class __TwigTemplate_4669c09a3eae82d76232fc4166412076 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("base-back.html.twig", "backoffice/categorie/show.html.twig", 1);
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 18
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["categorie"]) || array_key_exists("categorie", $context) ? $context["categorie"] : (function () { throw new RuntimeError('Variable "categorie" does not exist.', 18, $this->source); })()), "description", [], "any", false, false, false, 18), "html", null, true);
        echo "</td>
            </tr>
    ...
    <a href=\"";
        // line 26
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_evenement_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["categorie"]) || array_key_exists("categorie", $context) ? $context["categorie"] : (function () { throw new RuntimeError('Variable "categorie" does not exist.', 26, $this->source); })()), "id", [], "any", false, false, false, 26)]), "html", null, true);
        echo "\">edit</a>
...
";
    ...
    {
        return array (  124 => 28,  119 => 26,  114 => 24,  105 => 18,  97 => 13,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    ...
    <a href=\"{{ path('app_evenement_edit', {'id': categorie.id}) }}\">edit</a>

    {{ include('backoffice/categorie/_delete_form.html.twig') }}
{% endblock %}
", "backoffice/categorie/show.html.twig", "C:\\xampp2\\htdocs\\ExploraTerra-gestionVol\\templates\\backoffice\\categorie\\show.html.twig");
    }
}
